                ...
                <div class="clm" style="--w-lg:9; --w-md:4">
                    <div class="box__left__post">
                        <div class="box_inner__post">
                            <h2 class="title__postnews">Đăng tin tuyển dụng</h2>
                            <div class="rows__in2">
                            ...
                            <div class="rows__in2">
                                ...
                                <div class="rows__in2__right">
                                    <form action="" class="form__in2 toww">
                                        <input name="numberRecruitment" type="number">
                                    </form>
                                    <form action="" class="form__in2 toww">
                            ...
                            <div class="rows__in2">
                                ...
                                <div class="rows__in2__right">
                                    <form action="" class="form__in2">
                                        <input name="addressDetail" type="text" value="{{ Auth::guard('web')->user()->address }}">
                                    </form>
                                </div>
                            </div>
                            <div class="rows__in2">
                            ...
                            <div class="rows__in2">
                                ...
                                <div class="rows__in2__right">
                                    <form action="" class="form__in2">
                                        <input id="minSalary" name="minSalary" type="text" style="margin-right: 20px; width: 10%;">
                                        <p>-</p>
                                        <input id="maxSalary" name="maxSalary" type="text" style="margin-left: 20px; width: 10%;"> 
                            ...
                            <div class="rows__in2">
                                ...
                                <div class="rows__in2__right">
                                    <form action="" class="form__in2">
                                        <input name="dateExpiry" type="date" class="datepicker-personal" style="width: 40%;">
                                    </form>
                                </div>
                            </div>
                            <div class="rows__in2">
                                ...
                                <div class="rows__in2__right">
                                    <form action="" class="form__in2">
                                        <textarea name="" id="description" cols="30" rows="10" style="padding: 10px;"></textarea>
                                    </form>
                                </div>
                            </div>
                            <div class="rows__in2">
                                ...
                                <div class="rows__in2__right">
                                    <form action="" class="form__in2">
                                        <textarea name="" id="require" cols="30" rows="10" style="padding: 10px;"></textarea>
                                    </form>
                                </div>
                            </div>
                            <div class="rows__in2">
                                ...
                                <div class="rows__in2__right">
                                    <form action="" class="form__in2">
                                        <textarea name="" id="benefits" cols="30" rows="10" style="padding: 10px;"></textarea>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="inner__bottom__post" style="text-align: center;">
                                ...
                                <button class="btn__save__post" onclick="createPostRecruitment()">Đăng tuyển</button>
                            </div>
                        </div>
...
function createPostRecruitment(){
    ...
    formData.append('recruiter_id', '{{ Auth::guard('web')->user()->id }}');

    jQuery.ajax({
        url: `{{ route('createPostRecruitment') }}`, 
        method: 'POST', 
        data: formData,
        contentType: false, 
        processData: false,

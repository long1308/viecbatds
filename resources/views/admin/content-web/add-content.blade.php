...
@section('content')
    ...
    <!-- END: Top Bar -->
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                ...
                <div class="dropdown">
                    <button id="submitData" class="dropdown-toggle btn btn-primary shadow-md flex items-center" aria-expanded="false" data-tw-toggle="dropdown" onclick="submitContent()"> Lưu </button>
                </div>
            </div>
        </div>
        <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
                    ...
                    <div class="post__content tab-content">
                        <div id="contentTab" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                ...
                                <div class="mt-5">
                                    <input id="slug" name="slug" type="text" class="intro-y form-control py-3 px-4 box pr-10" placeholder="Nhập đường dẫn">
                                </div>
                            </div>
                            <br>
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="intro-y box p-5">
                    @if (isset($contentParent) && $contentParent->name)
                        <div>
                            ...
                            <div class="dropdown">
                                <div class="dropdown-toggle btn w-full btn-outline-secondary dark:bg-darkmode-800 dark:border-darkmode-800 flex items-center justify-start" role="button" aria-expanded="false" data-tw-toggle="dropdown">
                                    <div class="truncate">{{ $contentParent->name }}</div>
                                </div>
                            </div>
                        </div>
                    @endif
    ...
    <script>
        ...
        function sendSubmit() {
            ...
            formData.append('parent_id', {{ $contentParent->id ?? 0 }});
        ...
        function redirectList(){
            window.location.href = '{{ route('admin.content') }}?parent_id={{ $contentParent->id ?? 0 }}';
            return;
        }
    </script>
    <!-- Call Ajax -->

        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                <li class="p-2">
                    ...
                    <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">@if (isset(Auth::guard('admin')->user()->roles[0]->name))
                ...
                <li>
                    <a style="cursor: pointer;" class="dropdown-item hover:bg-white/5" onclick="logoutAdmin('{{ route('admin.logoutAdmin') }}', '{{ route('admin.login') }}')"> <i data-lucide="toggle-right" class="w-4 h-4 mr-2"></i> Đăng xuất </a>
                </li>
            </ul>
        </div>
    </div>

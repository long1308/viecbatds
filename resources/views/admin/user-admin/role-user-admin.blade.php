...
<div class="content">
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <div class="dropdown">
                <button class="dropdown-toggle btn btn-primary shadow-md flex items-center" aria-expanded="false" data-tw-toggle="modal" data-tw-target="#save-role-success-confirmation-modal" onclick="submitRole()"> Lưu </button>
            </div>
        </div>
    </div>
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
                ...
                <div class="post__content tab-content">
                    <div id="contentTab" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                            ...
                            <div class="mt-5">
                                <input type="text" name="name" class="intro-y form-control py-3 px-4 box pr-10" placeholder="Nhập tên vai trò">
                            </div>
                        </div>
                        {{-- <br>
                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
        ...
        <!-- END: Post Content -->
        <div id="save-role-success-confirmation-modal" class="modal" tabindex="-1" aria-hidden="false">
